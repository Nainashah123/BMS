                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-6">
                            <div className="topbar-adress">
                                <ul>
                                    <li className="line"><Link href="#" onClick={handleSmoothScroll}>Address : Sharjah, UAE</Link></li>
                                    <li><a href="mailto:info@nexsys.global" onClick={handleSmoothScroll}>info@nexsys.global</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
