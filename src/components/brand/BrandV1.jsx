                                ...
                                {BrandV1Data.map(brand =>
                                    <div className="col-lg-12" key={brand.id}>
                                        <div className="brand-thumb">
                                            <Link href={{ javascript: void (0) }} onClick={handlePreventClick}>
                                                {brand.brandThumb.startsWith('http') ? (
                                                    <div style={{
                                                        backgroundImage: `url("${brand.brandThumb}")`,
                                                    ...
                                                    <Image src={`/assets/images/brand/${brand.brandThumb}`} alt="image" width={274} height={94} />
                                                )}
                                            </Link>
                                        </div>
                                    </div>
