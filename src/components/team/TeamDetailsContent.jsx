                                            ...
                                            <div className="team-details-author-experience">
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <span className="value">Sharjah, UAE</span>
                                                    </li>
                                                    <li>
                                                        <span className="label">Phone:</span>
                                                        <span className="value"><a href="tel:+971506831025" className='tel'>+971 506831025</a></span>
                                                    </li>
                                                    <li>
                                                        <span className="label">Email:</span>
                                                        <a href="mailto:info@nexsys.global" className="value">info@nexsys.global</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="tel:0568103681" className="value">0568103681</a>
                                                    </li>
                                                </ul>
                                            </div>
